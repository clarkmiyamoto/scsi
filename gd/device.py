...
Copied verbatim from ``toy_3d_pointcloud_et/device.py`` (this repo duplicates small
per-experiment utilities rather than cross-importing between experiment folders).
"""
